...
class Migration20250404135943 extends Migration {
  ...
  async up() {
    ...
    this.addSql(`create table \`user\` (\`id\` integer not null primary key autoincrement, \`created_at\` datetime not null, \`updated_at\` datetime not null, \`username\` text not null, \`name\` text not null, \`password\` text not null);`);
...
exports.Migration20250404135943 = Migration20250404135943;
